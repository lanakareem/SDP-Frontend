...
package com.example.sdp.databinding;
...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton imageButton) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentMainBinding((ConstraintLayout) rootView, imageButton);
    }
